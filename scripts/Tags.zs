...
// bars
<tag:items:c:gold_bars>.add(<item:createdeco:gold_bars>);
<tag:items:c:gold_bars>.add(<item:charm:gold_bars>);
<tag:items:c:zinc_bars>.add(<item:createdeco:zinc_bars>);
<tag:items:c:brass_bars>.add(<item:createdeco:brass_bars>);
<tag:items:c:copper_bars>.add(<item:createdeco:copper_bars>);
<tag:items:c:copper_bars>.add(<item:charm:copper_bars>);
<tag:items:c:andesite_bars>.add(<item:createdeco:andesite_bars>);
